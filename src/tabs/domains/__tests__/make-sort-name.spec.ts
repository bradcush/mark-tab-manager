...
describe('makeSortName', () => {
    describe('when any sorting is specified', () => {
        ...
        test('should return name for end sorting of new tabs', () => {
            const type = 'granular';
        ...
        test('should properly sort source code urls', () => {
            const type = 'granular';
        ...
        test('should properly sort valid protocols', () => {
            const type = 'granular';
    ...
    describe('when granular sorting is specified', () => {
        test('should return name with shared subdomain precedence over domain', () => {
            const type = 'granular';
    ...
    describe('when shared sorting is specified', () => {
        test('should return name with domain precedence over shared subdomain', () => {
            const type = 'shared';
